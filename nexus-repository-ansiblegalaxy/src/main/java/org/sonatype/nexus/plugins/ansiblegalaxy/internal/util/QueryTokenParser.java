    ...
    extends TokenParser
{
   ...
   * parameter tokens.
   * If the pattern matches and, the resulting Map contains an entry for each variable in the pattern. The variable
   * names are keys, with the matching portions of the
